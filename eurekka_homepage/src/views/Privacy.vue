<template>
  <div style="text-align: left; margin: 1% 3% 1% 3%">
    <p class="ls2 lh6 bs5 ts4">
      <em class="emphasis">
        &lt;N차수열&gt;('http://eurekka.kr'이하 '유레까') </em
      >은(는) 「개인정보 보호법」 제30조에 따라 정부주체의 개인정보를 보호하고
      이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과
      같이 개인정보 처리방침을 수립·공개합니다.
    </p>
    <p class="ls2">
      ○ 이 개인정보처리방침은 <em class="emphasis">2021</em>년
      <em class="emphasis">5</em>월 <em class="emphasis">20</em>부터 적용됩니다.
    </p>
    <br />
    <p class="lh6 bs4">
      <strong
        >제1조(개인정보의 처리 목적)<br /><br /><em class="emphasis"
          >&lt;N차수열&gt;('http://eurekka.kr'이하 '유레까')</em
        >
        은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는
        개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이
        변경되는 겨우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는
    ...
    <ul class="list_indent2 mgt10">
      ...
      <p class="ls2">맞춤서비스 제공을 목적으로 개인정보를 처리합니다.</p>
      <br />
    </ul>
    <br />
    <br />
    <p class="lh6 bs4">
      ...
      <em class="emphasis"> &lt;N차수열&gt;</em>은(는) 법령에 따른 개인정보
      보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보
      보유·이용기간 내에서 개인정보를 처리·보유합니다.<br /><br />② 각각의
    ...
    <p class="ls2">
      <br /><br />① 정보주체는 N차수열에 대해 언제든지 개인정보
      열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
    </p>
    <p class="sub_p">
      ② 제1항에 따른 권리 행사는N차수열에 대해 「개인정보 보호법」 시행령
      제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
      있으며 N차수열은(는) 이에 대해 지체 없이 조치하겠습니다.
    </p>
    <p class="sub_p">
    ...
    <p class="sub_p">
      ⑥ N차수열은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
      처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를
      확인합니다.
    </p>
    <br /><br />
    <p class="lh6 bs4">
      <strong> 제4조(처리하는 개인정보의 항목 작성) </strong><br /><br />
      ① <em class="emphasis">&lt;N차수열&gt; </em>은(는) 다음의 개인정보 항목을
      처리하고 있습니다.
    </p>
    <ul class="list_indent2 mgt10">
    ...
    <ul class="list_indent2 mgt10">
      <li class="tt">2&lt; 제화 또는 서비스 제공 &gt;</li>
      <li>필수항목 : 카메라</li>
      <li>선택항목 :</li>
    </ul>
    <ul class="list_indent2 mgt10">
      <li class="tt">3&lt; 제화 또는 서비스 제공 &gt;</li>
      <li>필수항목 : 앱 실행 상태</li>
      <li>선택항목 :</li>
    </ul>
    <br /><br />
    ...
    <p class="ls2">
      <br />① &lt;N차수열&gt; 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
      개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.
      <br /><br />② 정보주체로부터 동의받은 개인정보 보유기간이 경과하거나
      처리목적이 달성되었음에도 불구하고 다른 법령에 따라 개인정보를 계속
      보존하여야 하는 경우에는, 해당 개인정보를 별도의 데이터베이스(DB)로
      옮기거나 보관장소를 달리하여 보존합니다.<br />1. 법령 근거 :<br />2.
      보존하는 개인정보 항목 : 계좌정보, 거래날짜<br />
      <br />③ 개인정보 파기의 절차 및 방법은 다음과 같습니다.<br />1.
      파기절차<br />
      &lt;N차수열&gt; 은(는) 파기 사유가 발생한 개인정보를 선정하고,
      &lt;N차수열&gt; 의 개인정보 보호책임자의 승인을 받아 개인정보를
      파기합니다.<br />
    </p>
    ...
    <p class="lh6 bs4">
      <strong
        >제6조(개인정보의 안전성 확보 조치)<em class="emphasis">
          <br /><br />&lt;N차수열&gt;</em
    ...
    <p class="lh6 bs4">
      <strong
        >제7조(개인정보 자동 수집 장치의 설치•운영 및 거부에 관한 사항)</strong
      >
    </p>
    <p class="ls2">
      <br /><br />N차수열 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
      ‘쿠키(cookie)’를 사용하지 않습니다.
    </p>
    <p class="sub_p mgt30"><strong>제8조 (개인정보 보호책임자) </strong></p>
    <p class="sub_p mgt10">
      ① <span class="colorLightBlue">N차수열</span> 은(는) 개인정보 처리에 관한
    ...
    <ul class="list_indent2 mgt10">
      ...
      <li>직책 :팀장</li>
      <li>직급 :팀장</li>
      <li>연락처 :01085747975, ajx0114@naver.com,</li>
    </ul>
    <p class="sub_p">
      ② 정보주체께서는 N차수열 의 서비스(또는 사업)을 이용하시면서 발생한 모든
      개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보
      보호책임자 및 담당부서로 문의하실 수 있습니다. N차수열 은(는) 정보주체의
    ...
    <p class="sub_p mgt30">
      <strong
        ...
        부서에 할 수 있습니다.<br />&lt;N차수열&gt;은(는) 정보주체의 개인정보
    ...
    분쟁해결이나 상담 등을 신청할 수 있습니다. 이 밖에 기타 개인정보침해의 신고,
    ...
    행정심판법이 정하는 바에 따라 행정심판을 청구할 수 있습니다.<br /><br />
    ...
    <br />
    <p class="sub_p">① 이 개인정보처리방침은 2021년 5월 20부터 적용됩니다.</p>
    <p class="sub_p"></p>
    <p class="sub_p"></p>
  </div>
</template>
